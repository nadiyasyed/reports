...
sys.path.append(os.path.join(PROJECT_BASE_PATH,'Apps').replace('\\','//'))
...
DATABASES = {
    'default': {
        ...
        'NAME': 'task_trackerdb',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'h8_w$2!sdl2u7fujz3an3$4jtqv3p5i#wac1ei0*uc!vai2(7%'
